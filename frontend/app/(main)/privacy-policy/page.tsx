...
import { BulletList, ContactCard, LegalPage, Section, Subsection } from "@/app/components/legal/LegalSections";
  ...
  return (
    <LegalPage title="Privacy policy" lastUpdated={LAST_UPDATED}>
        ...
        <p className="mt-6 text-ink-600 leading-relaxed">
          CampusVibe (“CampusVibe,” “we,” “us,” or “our”) respects your privacy. This Privacy Policy
          explains what information we collect, how we use it, and how we protect your information when
          you use the CampusVibe website and services.
        </p>
        ...
        <div className="mt-10">
          <Section number={1} title="Information we collect">
            ...
            <Subsection title="Account information">
              ...
              <p>
                ...
                authenticate your account, such as your name, email address, and profile picture, depending on
                the permissions provided by Google.
              </p>
              <p>
                When you create an account using email and password, we collect the information necessary to
                create and authenticate your account.
              </p>
              <p>
                We do not use your authentication information for purposes unrelated to operating your
                CampusVibe account.
              </p>
            </Subsection>
            ...
            <Subsection title="Profile information">
              <p>
                You may choose to provide information through your CampusVibe profile. This may include
                information such as:
              </p>
              <BulletList
                items={[
            ...
            <Subsection title="Activity on CampusVibe">
              ...
              />
              <p>
                This information may be used to operate the platform and provide features such as personalized
          ...
          <Section number={3} title="Sharing of information">
            ...
            <p>
              We currently do not provide user profile information or CampusVibe activity information to
          ...
          <Section number={4} title="Personalized recommendations">
            <p>
              CampusVibe may use information you provide, along with your activity on the platform, to
              personalize your experience.
            </p>
            <p>
              For example, your interests, followed clubs, searches, event views, and bookmarks may be used to
              help CampusVibe recommend events that are more relevant to you.
            </p>
            <p>
              This information is used within CampusVibe to improve your experience and is not sold to
              advertisers.
            </p>
          </Section>
          ...
          <Section number={5} title="Data security">
            <p>
              We take reasonable measures to protect user information from unauthorized access, misuse,
          ...
          <Section number={6} title="Your choices">
            ...
            <p>
              If you would like to request access to, correction of, or deletion of your personal information,
          ...
          <Section number={7} title="Children's privacy">
            <p>
              CampusVibe is intended primarily for university and college communities and is not designed for
              children under the age of 13.
            </p>
            <p>We do not knowingly collect personal information from children under 13.</p>
          </Section>

          <Section number={8} title="External services">
            <p>
              CampusVibe may use external services where necessary to operate certain features, such as Google
              OAuth for account authentication.
            </p>
            <p>
              Those services operate under their own terms and privacy policies. CampusVibe does not control how
              those external services process information outside of the CampusVibe platform.
            </p>
          </Section>
          ...
          <Section number={9} title="Changes to this privacy policy">
            ...
            <p>
              When we make changes, we will update the <strong className="font-semibold">“Last updated”</strong>{" "}
